! function() {
    ...
    function j(n) {
        function t() {
            var t = this.ownerDocument,
                e = this.namespaceURI;
            return e && e !== t.documentElement.namespaceURI ? t.createElementNS(e, n) : t.createElement(n)
        }
    ...
    function vt() {
        ...
        ko.point = function(a, o) {
            ko.point = n, r = (t = a) * Oa, u = Math.cos(o = (e = o) * Oa / 2 + Ua / 4), i = Math.sin(o)
        }, ko.lineEnd = function() {
            n(t, e)
        }
    }
    ...
    function Nt() {
        ...
        var t, e, r;
        Uo.point = function(u, i) {
            u *= Oa;
            var a = Math.cos(i *= Oa);
            t = a * Math.cos(u), e = a * Math.sin(u), r = Math.sin(i), Uo.point = n, kt(t, e, r)
        }
    }
    ...
    function At() {
        ...
        var t, e, r, u, i;
        Uo.point = function(a, o) {
            t = a, e = o, Uo.point = n, a *= Oa;
            var l = Math.cos(o *= Oa);
            r = l * Math.cos(a), u = l * Math.sin(a), i = Math.sin(o), kt(r, u, i)
        }, Uo.lineEnd = function() {
            n(t, e), Uo.lineEnd = Et, Uo.point = St
        }
    }
    ...
    function jt(n) {
        ...
        return {
            ...
            point: function(i, a) {
                var o = i > 0 ? Ua : -Ua,
                    l = Ma(i - e);
                Ma(l - Ua) < Da ? (n.point(e, r = (r + a) / 2 > 0 ? Ha : -Ha), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(o, r), n.point(i, r), t = 0) : u !== o && l >= Ua && (Ma(e - u) < Da && (e -= u * Da), Ma(i - o) < Da && (i -= o * Da), r = Ft(e, r, i, a), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(o, r), t = 0), n.point(e = i, r = a), u = o
            },
            lineEnd: function() {
                n.lineEnd(), e = r = NaN
            },
    ...
    function Ht(n, t, e, r) {
        var u;
        if (null == n) u = e * Ha, r.point(-Ua, u), r.point(0, u), r.point(Ua, u), r.point(Ua, 0), r.point(Ua, -u), r.point(0, -u), r.point(-Ua, -u), r.point(-Ua, 0), r.point(-Ua, u);
    ...
    function Ot(n, t) {
        ...
        for (var o = 0, l = t.length; l > o; ++o) {
            var c = t[o],
                s = c.length;
            if (s)
                for (var f = c[0], h = f[0], g = f[1] / 2 + Ua / 4, p = Math.sin(g), v = Math.cos(g), d = 1;;) {
                    d === s && (d = 0), n = c[d];
                    var m = n[0],
                        y = n[1] / 2 + Ua / 4,
                        M = Math.sin(y),
                        ...
                        S = w > Ua,
                        k = p * M;
                    if (So.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))), i += S ? b + _ * ja : b, S ^ h >= e ^ m >= e) {
                        var N = yt(dt(f), dt(n));
                        bt(N);
                        var E = yt(u, N);
                        bt(E);
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    var g, p = [f, h],
                        v = t(f, h),
                        d = a ? v ? 0 : u(f, h) : v ? u(f + (0 > f ? Ua : -Ua), h) : 0;
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                var E = S - w,
                    A = Ma(E - Ua) < Da,
                    C = A || Da > E;
                if (!A && k > N && (_ = k, k = N, N = _), C ? A ? k + N > 0 ^ b[1] < (Ma(b[0] - w) < Da ? k : N) : k <= b[1] && b[1] <= N : E > Ua ^ (w <= b[0] && b[0] <= S)) {
                    var z = xt(d, (-m + x) / y);
    ...
    function Vt(n) {
        ...
        return u.parallels = function(n) {
            return arguments.length ? r(t = n[0] * Ua / 180, e = n[1] * Ua / 180) : [t / Ua * 180, e / Ua * 180]
        }, u
    }
    ...
    function te(n) {
        function t(t, e) {
            n.moveTo(t + a, e), n.arc(t, e, a, 0, ja)
        }
    ...
    function oe(n) {
        ...
        return t.stream = function(n) {
                ...
                return arguments.length ? (b = null == n ? (w = n, jo) : It((w = +n) * Oa), u()) : w
    ...
    function he(n) {
        return function(t, e) {
            return t += n, [t > Ua ? t - ja : -Ua > t ? t + ja : t, e]
        }
    }
    ...
    function ve(n, t) {
        ...
        return function(u, i, a, o) {
            var l = a * t;
            null != u ? (u = de(e, u), i = de(e, i), (a > 0 ? i > u : u > i) && (u += a * ja)) : (u = n + a * ja, i = n - .5 * l);
    ...
    function Fe(n) {
        var t = n.circle,
            ...
            o = [n];
        je(n);
        for (var l = i; l.circle && Ma(e - l.circle.x) < Da && Ma(r - l.circle.cy) < Da;) i = l.P, o.unshift(l), je(l), l = i;
        o.unshift(l), Be(l);
        for (var c = a; c.circle && Ma(e - c.circle.x) < Da && Ma(r - c.circle.cy) < Da;) a = c.N, o.push(c), je(c), c = a;
        o.push(c), Be(c);
        var s, f = o.length;
    ...
    function He(n) {
        ...
        if (il.insert(t, l), t || e) {
            if (t === e) return Be(t), e = Ue(t.site), il.insert(l, e), l.edge = e.edge = Ke(t.site, l.site), $e(t), void $e(e);
    ...
    function Lr(n, t) {
        var e;
        return arguments.length < 2 && (t = .45), arguments.length ? e = t / ja * Math.asin(1 / n) : (n = 1, e = t / 4),
            function(r) {
                return 1 + n * Math.pow(2, -10 * r) * Math.sin((r - e) * ja / t)
            }
    }
    ...
    function ji(n) {
        for (var t, e, r, u, i = [], a = Ui(n), o = -1, l = n.length - 1; ++o < l;) t = Pi(n[o], n[o + 1]), Ma(t) < Da ? a[o] = a[o + 1] = 0 : (e = a[o] / t, r = a[o + 1] / t, u = e * e + r * r, u > 9 && (u = 3 * t / Math.sqrt(u), a[o] = u * e, a[o + 1] = u * r));
    ...
    var co = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(Un);
    ...
    var wo, So = new st,
        ko = {
            ...
            polygonEnd: function() {
                var n = 2 * So;
                wo += 0 > n ? 4 * Ua + n : n, ko.lineStart = ko.lineEnd = ko.point = b
            }
        };
    oa.geo.bounds = function() {
        ...
        No = Eo = Ao = Co = zo = Lo = qo = To = Ro = Do = Po = 0, oa.geo.stream(n, Uo);
        var t = Ro,
            e = Do,
            r = Po,
            u = t * t + e * e + r * r;
    ...
    var No, Eo, Ao, Co, zo, Lo, qo, To, Ro, Do, Po, Uo = {
            sphere: b,
            point: St,
            lineStart: Nt,
            lineEnd: Et,
